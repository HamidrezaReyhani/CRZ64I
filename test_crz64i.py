...
def test_benchmarking():
    ...
    print(
        f"✓ RAPL energy measurement: {'Available' if rapl_available else 'Not available (requires root)'}"
    )
...
def main():
    ...
    print(
        "  python3 -c \"from compiler import CRZCompiler; c = CRZCompiler(); result = c.compile(open('file.crz').read())\""
    )
